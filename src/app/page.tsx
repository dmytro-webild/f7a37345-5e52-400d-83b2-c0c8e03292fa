    ...
    >
      ...
      <div id="hero" data-section="hero">
        <HeroSplit
          ...
          description="Мы превращаем визиты к стоматологу в комфортный опыт. 

Сочетая передовые цифровые технологии, безболезненные методы и эстетическое искусство создания безупречных улыбок. 

Адрес: Ул. Шейха Али Митаева."
