      ...
      <div id="doctors" data-section="doctors">
        <TeamCardTwo
          ...
          members={[
            ...
            { id: "7", name: "Д-р Руслан", role: "Имплантолог", description: "Эксперт в области одномоментной имплантации и протезирования.", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3Dw84RnSEOsmbFdYVY2F51sVH09/uploaded-1779308675600-46soe5n4.jpg" }
          ]}
        />
      </div>
